 ...
 *
 * This file and proprietary source code may only be used and distributed
 * under the Widevine Master License Agreement.
 *
 * APIs needed to support Widevine's crypto algorithms.
 *
...
#define OEMCRYPTO_KEY_CONTROL_SIZE              16
#define OEMCRYPTO_KEY_IV_SIZE                   16
#define OEMCRYPTO_MAC_KEY_SIZE                  32
#define OEMCRYPTO_KEY_ID_LEN                    32
#define OEMCRYPTO_KEY_DATA_LEN                  32
#define OEMCRYPTO_ARRAY_SIZE                    128
#define OEMCRYPTO_MAX_KEY_NUM                   32
#define OEMCRYPTO_MAX_BUFFER_SIZE               (1024*100)

typedef struct {
  uint8_t signature[OEMCRYPTO_MAC_KEY_SIZE];
  uint8_t context[OEMCRYPTO_MAC_KEY_SIZE];
  uint8_t iv[OEMCRYPTO_KEY_IV_SIZE];
  uint8_t enc_rsa_key[];
} WrappedRSAKey;
