...
//INSTANTIATE_TEST_CASE_P(SS_TE_Tests, StorageServiceTest,   ::testing::Values(STORAGE_CLIENT_TE_PORT));
INSTANTIATE_TEST_CASE_P(SS_TN_Tests, StorageServiceTest,   ::testing::Values(STORAGE_CLIENT_TN_PORT));
